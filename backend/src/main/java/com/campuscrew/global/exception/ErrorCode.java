...
public enum ErrorCode {
    ...
    TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH_003", "인증토큰이 만료되었습니다."),
    TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "AUTH_004", "유효하지 않는 인증 토큰입니다."),
    ...
    INVALID_TASK_STATUS(HttpStatus.BAD_REQUEST, "VALED_003", "유효하지 않는 상태값입니다."),
